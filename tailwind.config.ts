	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { boxShadow: '0 0 5px hsl(var(--terminal-accent))' },
					'50%': { boxShadow: '0 0 20px hsl(var(--terminal-accent)), 0 0 30px hsl(var(--terminal-accent))' }
				},
				'float': {
			...
			animation: {
				...
				'typing': 'typing 2s steps(40) 1s both',
